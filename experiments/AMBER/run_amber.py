...
if __name__ == "__main__":
    ...
    parser.add_argument("--question-file", type=str, default="./data/query/query_discriminative.json")
    parser.add_argument("--answers-file", type=str, default="output/llava-1.5_AMBER.jsonl")
