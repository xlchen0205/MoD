...
def eval_model(args):
    ...
    image_list_data_path = "./data/chair-500.jsonl"
    with open(image_list_data_path, 'r') as image_list_file:
        for line in tqdm(image_list_file):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--answers-file", type=str, default="output/llava-1.5_CHAIR.jsonl")
